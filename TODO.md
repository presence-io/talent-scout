...
- [ ] 多源合并 + 信号去重 → [07 §3](docs/07-data-model.md)
- [ ] 身份识别：5-Tier 信号 + noisy-or → [04](docs/04-identity.md)
- [ ] 规则评分：SkillFeatures、AIDepthFeatures、ReachabilityFeatures、FitFeatures → [05 §3-6](docs/05-evaluation.md)
- [ ] 活跃度前置检查（< 10 贡献 → -3.0 惩罚）→ [05 §1.5](docs/05-evaluation.md)
- [ ] 最终评分 + 推荐动作 → [05 §7](docs/05-evaluation.md)
- [ ] 多源合并 + 信号去重 → [07 §3](docs/07-data-model.md)
- [ ] 身份识别：5-Tier 信号 + noisy-or → [04](docs/04-identity.md)
- [ ] 规则评分：SkillFeatures、AIDepthFeatures、ReachabilityFeatures、FitFeatures → [05 §3-6](docs/05-evaluation.md)
- [ ] 活跃度前置检查（< 10 贡献 → -3.0 惩罚）→ [05 §1.5](docs/05-evaluation.md)
- [ ] 最终评分 + 推荐动作 → [05 §7](docs/05-evaluation.md)
- [ ] Golden Set 验证框架 → [09 §4](docs/09-testing.md)
- [ ] 单元测试：identity、scoring、deduplication → [09 §2.1](docs/09-testing.md)
